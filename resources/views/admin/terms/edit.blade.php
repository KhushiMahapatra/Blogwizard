    ...
    <div class="container">
        ...
        <form action="{{ route('admin.terms.update') }}" method="POST">
            ...
            <div class="form-group">
                <textarea id="myeditpage" name="content" class="form-control" rows="10">{{ old('content', $term->content) }}</textarea>
            </div>
            <button type="submit" class="btn btn-primary mb-3">Update Terms</button>
        </form>
    </div>
</div>
